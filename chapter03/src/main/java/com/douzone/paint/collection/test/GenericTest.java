...
public class GenericTest {
	...
	public static void main(String[] args) {
		...
		MyStack<Drawable> d1 = new MyStack<>(20);
		
		drawShapeLayer(list1, d1);
	 ...
	 * 2) 부모들만(자신포함)
	 * 3) <T super Type> 오류!!
	 *    - 함수 구현 블록(클래스 구현 블록) 안 에서 T 타입이 모호하기 때문에 구현이 불가능 하다
...
//	}
	...
	public static void drawShapeLayer(List<? extends Shape> in, MyStack<? super Drawable> out) {
		//							  Lower Bounded, Producer	Upper Bounded, Consumer
//		잘못된사용
